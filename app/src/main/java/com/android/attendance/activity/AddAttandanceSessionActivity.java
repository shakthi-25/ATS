...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "BCA","BBA","BCom","BA","BSc"};
	private String[] yearString = new String[] {"First","Second","Third"};
	private String[] subjectSEString = new String[] {"Code1","Code2"};
	private String[] subjectTEString = new String[] {"Code3","Code4"};
	private String[] subjectBEString = new String[] {"Code5","Code6"};

	private String[] subjectFinal = new String[] {"Code1","Code2","Code3","Code4","Code5","Code6"};
